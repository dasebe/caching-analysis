...
dt <- rbind(lcr,ofma,belady,slp,mcf)
...
dt2[,unique(alg)]
llbreaks=c("slp","lcr","ofma","mcftime","belady")
llabels=c("LP","Localratio","OFMA","FOO","Belady")
...
ggplot(dt3,aes(tsize2/1e6,mt,color=alg2,linetype=alg2))+
